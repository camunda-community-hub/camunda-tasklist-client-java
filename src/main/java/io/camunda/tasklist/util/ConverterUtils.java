...
public class ConverterUtils {
    ...
    public static List<Variable> toVariables(List<VariableSearchResponse> variables) throws TaskListException {
        try {
    ...
    public static Task toTask(Object sourceTask, List<VariableSearchResponse> variables) throws TaskListException {
        try {
            ...
            task.setVariables(toVariables(variables));
        ...
        try {
            ...
            for (Map.Entry<String, Object> entry : variablesMap.entrySet()) {
                if (entry.getValue() != null) {
                    variables.add(new VariableInputDTO().name(entry.getKey())
